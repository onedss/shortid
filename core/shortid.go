...
// Package core enables the generation of short, unique, non-sequential and by default URL friendly
...
//
// Although heavily inspired by the node.js core library this is
